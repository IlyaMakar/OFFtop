	...
	return (
		<>
					...
					>
						...
						>
							<span className='text-white'>
								Этот {dirType} перемещен в корзину.
							</span>
							<Button
								size='sm'
								variant='outline'
			...
			<div className='flex justify-center items-center flex-col mt-2 relative'>
				<div className='w-full self-center max-w-[800px] flex-col px-7 lg:my-8'>
					...
					<div className='flex'>
						...
						rounded-md'
						>
							{details.bannerUrl ? 'Изменить баннер' : 'Добавить баннер'}
						</BannerUpload>
						{details.bannerUrl && (
							<Button
					...
					<span className='flex mt-2 text-muted-foreground text-xs'>
						{dirType.toUpperCase()}
					</span>
				</div>
